...
new #[Layout('components.layouts.tenant.guest', ['eyebrow' => 'Recuperar acesso', 'heading' => 'Redefinir senha', 'subtitle' => 'Escolha uma nova senha para a sua conta.'])] class extends Component {
    public string $token = '';
