...
new #[Layout('components.layouts.tenant.guest', ['eyebrow' => 'Recuperar acesso', 'heading' => 'Esqueci minha senha', 'subtitle' => 'Informe seu e-mail institucional e enviaremos um link para redefinir sua senha.'])] class extends Component {
    ...
    public function sendResetLink(): void
    {
        ...
        Password::broker('tenant_users')->sendResetLink(['email' => $this->email]);
...
<div class="w-full">
    ...
    <p class="mt-6 text-center text-sm text-base-content/70">
        Lembrou a senha?
        <a href="{{ route('tenant.login') }}" wire:navigate class="link link-primary font-medium no-underline">
            Voltar para o login
        </a>
    </p>
</div>
